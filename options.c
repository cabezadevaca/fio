...
struct fio_option fio_options[FIO_MAX_OPTS] = {
	...
	{
		.name	= "dedupe_buf_randrepeat",
		.alias	= "buf_randrepeat",
		.lname	= "Random repeatable dedupe buffers",
		.type	= FIO_OPT_BOOL,
		.off1	= offsetof(struct thread_options, buf_rand_repeatable),
		.help	= "Use repeatable random IO pattern for dedupe buffers",
		.def	= "0",
		.parent = "rw",
		.hide	= 1,
		.category = FIO_OPT_C_IO,
	...
	},
	{
		...
		.lname	= "The random generator seed",
		.type	= FIO_OPT_STR_VAL,
		.off1	= offsetof(struct thread_options, buf_rand_seed),
		.help	= "Set the random generator seed value",
		.def	= "0x87",
		.parent = "rw",
		.category = FIO_OPT_C_IO,
...
#error "FIO_HAVE_IOPRIO_CLASS requires FIO_HAVE_IOPRIO"
	...
	{
		.name	= "dedupe_bs",
		.lname	= "Dedupe Block size",
		.alias	= "dedupe_blocksize",
		.type	= FIO_OPT_ULL,
		.off1	= offsetof(struct thread_options, dedupe_block_size),
		.minval = 0,
		.help	= "Dedupe Block size unit, it works for dedupe_mode2 only",
		.def	= "0",
		.parent = "rw",
		.hide	= 1,
		.interval = 512,
	...
	{
		.name	= "dedupe_total_test_area_size",
		.lname	= "Total test area size",
		.alias	= "dedupe_total_ta",
		.type	= FIO_OPT_ULL,
		.off1	= offsetof(struct thread_options, dedupe_total_ta),
		.minval = 0,
		.help	= "Total size of all files. It works for dedupe_mode2 only for calculation of number of dedupe patterns",
		.def	= "0",
		.parent = "rw",
		.hide	= 1,
		.category = FIO_OPT_C_IO,
	...
	{
		.name	= "dedupe_min_run",
		.lname	= "Minimum sequence of dedupable or unique blocks.",
		.type	= FIO_OPT_INT,
		.off1	= offsetof(struct thread_options, dedupe_min_run),
		.maxval	= 128,
		.minval	= 1,
		.help	= "Minimum sequence of dedupable or unique blocks, matters when using use_unique_bitmap=1",
		.interval = 1,
		.def = "1",
		.category = FIO_OPT_C_IO,
		.group	= FIO_OPT_G_IO_BUF,
	...
	{
		.name	= "dedupe_max_run",
		.lname	= "Maximum sequence of dedupable or unique blocks.",
		.type	= FIO_OPT_INT,
		.off1	= offsetof(struct thread_options, dedupe_max_run),
		.maxval	= 128,
		.minval	= 1,
		.help	= "Maximum sequence of dedupable or unique blocks, matters when using use_unique_bitmap=1",
		.interval = 1,
		.def = "32",
		.category = FIO_OPT_C_IO,
		.group	= FIO_OPT_G_IO_BUF,
	...
	{
		.name	= "dedupe_loadgen_num",
		.lname	= "Sequence number of a Load Generator for dedupe_mode2 deduplication",
		.alias	= "lg_num",
		.type	= FIO_OPT_INT,
		.off1	= offsetof(struct thread_options, lg_num),
		.maxval	= 100,
		.minval	= 0,
		.help	= "Sequence number of a LG for dedupe_mode2 deduplication",
		.interval = 1,
		.def = "0",
		.category = FIO_OPT_C_IO,
		.group	= FIO_OPT_G_IO_BUF,
	...
	{
		.name	= "dedupe_loadgen_count",
		.lname	= "Total number of a Load Generators for dedupe_mode2",
		.alias	= "lg_cnt",
		.type	= FIO_OPT_INT,
		.off1	= offsetof(struct thread_options, lg_cnt),
		.maxval	= 100,
		.minval	= 1,
		.help	= "Total number of a LG for dedupe-mode2 deduplication",
		.interval = 1,
		.def = "1",
		.category = FIO_OPT_C_IO,
		.group	= FIO_OPT_G_IO_BUF,
	...
	{
		.name	= "dedupe_use_unique_bitmap",
		.lname	= "Create unique bitmap prior of a run for dedupe_mode2 deduplication",
		.alias	= "use_unique_bitmap",
		.type	= FIO_OPT_BOOL,
		.off1	= offsetof(struct thread_options, use_unique_bitmap),
		.help	= "Create unique bitmap for job for dedupe_mode2 deduplication",
		.def	= "0",
		.category = FIO_OPT_C_IO,
		.group	= FIO_OPT_G_IO_BUF,
	},
	...
	},
	{
		...
		.posval	= {
			 ...
			 { .ival = "working_set2",
			     .oval = DEDUPE_MODE_WORKING_SET2,
			     .help = "calculate page number by LBA and choose a page from a pregenerated dedupe buffer manipulating some bytes in the buffer",
			   },
